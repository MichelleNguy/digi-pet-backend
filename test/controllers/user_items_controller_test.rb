...
class UserItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_item" do
    assert_difference('UserItem.count') do
      post user_items_url, params: { user_item: { item_id: @user_item.item_id, user_id: @user_item.user_id } }, as: :json
    end
  ...
  test "should update user_item" do
    patch user_item_url(@user_item), params: { user_item: { item_id: @user_item.item_id, user_id: @user_item.user_id } }, as: :json
    assert_response 200
  end
